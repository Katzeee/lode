...
// T4-b transport integration: one secured transport carries the membership doc over a PLAINTEXT
...
describe("BrokerClientSyncTransport — membership-doc plaintext + content sealed (T4-b)", () => {
