/**
 * The broker routing core (design sync-design.md §3) — ported from the validated P6 playground
 * (`experiments/sync-transport/src/broker.ts`). This is the pure, socket-free routing layer; the
