...
function CustomThemeSpecimen() {
  ...
  return (
    <Specimen
      ...
      description="Lode accepts any CSS as a user theme, loaded after the token stylesheet. Overriding the documented --lode-color-* variables is the whole contract; the built-in contrast guarantees do not apply to what you write here."
