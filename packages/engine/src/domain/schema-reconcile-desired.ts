...
import { ManagedKind, type SchemaProvenance } from "./managed-child-state.js";
import { readSchemaIds } from "./schema-membership.js";
import { isFieldDef, readFieldDefPresence, requireSchema } from "./system-entity.js";
import type { DesiredManagedChild, DesiredManagedChildInput } from "./schema-reconcile-model.js";
