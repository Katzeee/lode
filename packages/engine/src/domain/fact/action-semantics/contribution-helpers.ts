...
import type { IdentityContribution, IdentityRole, SemanticIdentity } from "./types.js";
...
export function referenceAndRequire(identityValue: SemanticIdentity): IdentityContribution {
  return identity(identityValue, "relate", "require");
}
