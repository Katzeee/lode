...
export type DefinitionNodeType = Extract<NodeType, "supertag-definition" | "field-definition">;

export const SUPERTAG_DEFINITION_NODE_TYPE = "supertag-definition" as const satisfies NodeType;
