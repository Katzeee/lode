...
export function assertFieldConfigurationSetActionShape(value: Record<string, unknown>): void {
  requireString(value.fieldDefinitionId, "Field Definition identity");
  assertObject(value.configuration, "Field Definition configuration");
