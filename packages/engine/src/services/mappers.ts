...
import type { FieldAddMode, FieldValueInput as DomainFieldValueInput } from "../domain/field.js";
import type { FieldPresence, FieldType } from "../domain/system-entity.js";
