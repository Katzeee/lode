...
async function createComposedSearchFixture(workspace: ProposalWorkspace): Promise<void> {
  await expectPublished(
    workspace,
...
async function expectPublished(workspace: ProposalWorkspace, mutationCommand: MutationCommand): Promise<void> {
