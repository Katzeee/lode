...
async function createHostAndTarget(workspace: ProposalWorkspace): Promise<void> {
...
async function nodes(workspace: ProposalWorkspace, perspective: "origin" | "review"): Promise<ProjectionPage<"nodes">> {
...
async function projection(workspace: ProposalWorkspace, perspective: "origin" | "review"): Promise<InlineProjection> {
