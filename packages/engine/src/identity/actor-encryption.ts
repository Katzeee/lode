...
import { edwardsToMontgomeryPriv, edwardsToMontgomeryPub } from "../utils/crypto/curve.js";
import {
 ...
 * private derived from their Ed25519 seed. The generic Edwards↔Montgomery map lives in
 * `utils/crypto/curve.ts`; the AES-256-GCM primitive in `utils/crypto/aes.ts`. This module owns the
 * actor-typed wrappers + the sealed-box (ephemeral X25519 + ECDH + HKDF-SHA256 + AES-256-GCM).
 *
